...
class MemoryCallbackHandler {
    ...
    create(request, newResource, callback) {
        ...
        let r
        try {
            r = this.#promiseHandler.create(request, newResource)
        } catch(e) {
            callback(e)
            return
        }
    ...
    delete(request, callback) {
        try {
            this.#promiseHandler.delete(request)
        } catch(e) {
            callback(e)
            return
        }
    ...
    find(request, callback) {
        ...
        let r
        try {
            r = this.#promiseHandler.find(request)
        } catch(e) {
            callback(e)
            return
        }
    ...
    search(request, callback) {
        ...
        let rc
        try {
            [rs, rc] = this.#promiseHandler.search(request)
        } catch (e) {
            callback(e)
            return
        }
    ...
    update(request, partialResource, callback) {
        ...
        let r
        try {
            r = this.#promiseHandler.update(request, partialResource)
        } catch(e) {
            callback(e)
            return
        }

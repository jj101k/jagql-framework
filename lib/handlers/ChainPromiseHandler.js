 ...
 * @typedef {import("../../types/ChainPromiseHandler").ChainPromiseHandler} ChainPromiseHandlerT
 */
...
class ChainPromiseHandler extends Handler {
     ...
     * @template {Parameters<Exclude<import("../../types/PromiseHandler").PromiseHandler<R>[M], undefined>>} P
     * @param {M} action

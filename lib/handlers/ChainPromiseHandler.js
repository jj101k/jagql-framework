 ...
 * @typedef {import("./ChainPromiseHandler.js").ChainPromiseHandler} ChainPromiseHandlerT
 */

/**
 * @template R
 * @typedef {import("./PromiseHandler.js").PromiseHandler<R>} PromiseHandler<R>
 */
 ...
 */
export class ChainPromiseHandler {
    get handlesFilter() {
        return this.otherHandler?.handlesFilter ?? false
    }

    get handlesSort() {
        return this.otherHandler?.handlesSort ?? false
    }

    get ready() {
        return this.otherHandler?.ready ?? false
    }

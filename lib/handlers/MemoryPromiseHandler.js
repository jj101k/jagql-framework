 ...
 */
export class MemoryPromiseHandler extends Handler {
    /**
     * @template R
     * @param {R} objOrObjs
     * @returns {R}
     ...
     *
     * @param {import("../../types/JsonApiRequest.js").JsonApiSearchRequest<R>} request
     * @param {R[]} list
     */
     ...
     *
     * @param {import("../../types/JsonApiRequest.js").JsonApiCreateRequest<R>} request
     * @param {R} newResource
     */
     ...
     *
     * @param {import("../../types/JsonApiRequest.js").JsonApiDeleteRequest<R>} request
     */
     ...
     *
     * @param {import("../../types/JsonApiRequest.js").JsonApiFindRequest<R>} request
     */
    find(request) {
     ...
     *
     * @param {import("../../types/JsonApiRequest.js").JsonApiUpdateRequest<R>} request

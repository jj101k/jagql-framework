...
export class MemoryPromiseHandler extends Handler {
     ...
     *
     * @param {import(".././JsonApiRequest.js").JsonApiSearchRequest<R>} request
     * @param {R[]} list
     */
     ...
     *
     * @param {import(".././JsonApiRequest.js").JsonApiCreateRequest<R>} request
     * @param {R} newResource
     */
     ...
     *
     * @param {import(".././JsonApiRequest.js").JsonApiDeleteRequest<R>} request
     */
     ...
     *
     * @param {import(".././JsonApiRequest.js").JsonApiFindRequest<R>} request
     */
    find(request) {
     ...
     *
     * @param {import("../JsonApiRequest.js").JsonApiUpdateRequest<R>} request

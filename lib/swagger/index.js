...
export class swaggerGenerator {
     ...
     */
    static generateDocumentation(configStore, inferredBaseUrl, resources) {
        const swaggerDoc = this.#getSwaggerBase(configStore, inferredBaseUrl)
        swaggerDoc.paths = swaggerPaths.getPathDefinitions(resources)
        swaggerDoc.definitions = swaggerResources.getResourceDefinitions(resources)
        return swaggerDoc
    }

...
export class jsonApi {
    ...
    static get relationshipStore() {
        return this.#inst.#relationshipStore
    }
     ...
     * @returns
     */
    static getToManyRelationsFor = (resourceConfig) => this.#inst.getToManyRelationshipsFor(resourceConfig)
     ...
     * @returns
     */
    static getToManyRelationshipsFor = (resourceConfig) => this.#inst.getToManyRelationshipsFor(resourceConfig)
     ...
     *
     */
    #responseHelper = new responseHelper(this.#relationshipStore)
     ...
     */
    constructor() {
        this.#router = new Router(this.#apiConfig, this.#resources, this.#responseHelper)

...
module.exports = class jsonApi {
     ...
     * @param {(req: import("../types/JsonApiRequest").JsonApiRequest, cb: () => void) => void} authFunction
     */
    ...
    /**
     * @param {(req: import("../types/JsonApiRequest").JsonApiRequest) => Promise<void>} authFunction
     */

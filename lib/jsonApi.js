...
module.exports = class jsonApi {
     ...
     *
     */
    static #router = new Router(ConfigStore.inst)
    /**
     * @type {{config: import("../types/jsonApi.js").ApiConfig}}
     */
    static #apiConfig = ConfigStore.inst
    /**
     *
     */
     ...
     */
    static authenticate = this.#router.authenticateWithCallback.bind(this.#router)

    /**
     * @type {import("../types/jsonApi.js").authenticate}
     */
    static authenticateWithCallback = this.#router.authenticateWithCallback.bind(this.#router)

    /**
     * @type {import("../types/jsonApi.js").authenticateWithPromise}
     */
    static authenticateWithPromise = this.#router.authenticateWithPromise.bind(this.#router)
     ...
     * @returns
     */
    static getExpressServer = () => this.#router.getExpressServer()
    ...
    static initialise(injectMiddleware) {
        ...
        internalError.register(this.#router, configStore)

        if(injectMiddleware) {
            injectMiddleware()
        }
        notFound.register(this.#router, configStore)
    }

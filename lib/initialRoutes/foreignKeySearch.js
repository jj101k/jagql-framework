  ...
  static register() {
    ...
    router.bindRoute({
      ...
      try {
        ...
        if (!Relation.hasProperty(resourceConfig, foreignKey)) {
          throw {
            status: "403",
            code: "EFORBIDDEN",
        ...
        if (!Relation.getRelation(resourceConfig, foreignKey)) {
          throw {
            status: "403",
            code: "EFORBIDDEN",
            title: "Invalid foreign key lookup",
        ...
        const searchResults = Relation.hasProperty(resourceConfig, foreignKey) ?

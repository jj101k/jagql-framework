 ...
 *
 * @param {*} config
 * @param {(req: any, resourceConfig: import("../types/ResourceConfig.js").ResourceConfig<any>, res: any) => *} callback
 */
...
router._getParams = req => {
  ...
  if (jsonApi._apiConfig.urlPrefixAlias) {
    ...
    urlObj.protocol = jsonApi._apiConfig.protocol
    urlObj.hostname = jsonApi._apiConfig.hostname
    urlObj.port = jsonApi._apiConfig.port
    combined = urlObj.toString()
  }

...
module.exports = class postProcess {
     ...
     * @param {import('../types/JsonApiResponse.js').JsonApiResponseBodyWithMeta} response
     */
    static async handleAny(request, response) {
        // Same as handleMulti, currently.
        return this.handleMulti(request, response)
    }
     ...
     * @param {import('../types/JsonApiResponse.js').JsonApiResponseBodyWithMeta} response
     */
    static async handleMulti(request, response) {
        ...
        return this.handleSingle(request, response)
    }
     ...
     * @param {import('../types/JsonApiResponse.js').JsonApiResponseBodyWithMeta} response
     */
    static async handleSingle(request, response) {
    ...
    static async fetchRelatedResources(request, mainResource) {
        ...
        const resourceUrisToFetch = Object.keys(resourcesByType).map(type => {
            ...
            return `${ConfigStore.config.pathPrefix + type}/?${query}`
        })

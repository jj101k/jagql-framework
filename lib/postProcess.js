...
module.exports = class postProcess {
  ...
  static async #postProcess(request, response, name, f) {
    ...
    await new Promise(
      (resolve, reject) => f(request, response, (err) => err ? reject(err) : resolve()))
   ...
   * @param {*} callback
   */
  static async handle(request, response, callback) {
   ...
   * @returns
   */
  static async _fetchRelatedResources(request, mainResource, callback) {

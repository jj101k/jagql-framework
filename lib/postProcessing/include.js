...
module.exports = class includePP {
  ...
  static #fillIncludeTree(includeTree, request, callback) {
    ...
    ****/
    ...
    for(const relation of Object.keys(map.primary)) {
      const ids = [...new Set(map.primary[relation])]
    ...
    for(const relation of Object.keys(map.foreign)) {
      const ids = [...new Set(map.foreign[relation])]

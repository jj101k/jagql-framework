...
module.exports = class filter {
  ...
  static #filterKeepObject(someObject, filters) {
    for (const [filterName, allowList] of Object.entries(filters)) {
      ...
      if (filterName === 'id') {
        ...
        const attributeMatches =
          this.#attributesMatchesOR(attributeValue, allowListSimple, allowListComplex)
        ...
        const relationshipMatches =
          this.#relationshipMatchesOR(relationships, allowListSimple)

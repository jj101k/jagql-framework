...
const DummyFilterHelper = require("./DummyFilterHelper.js")
...
module.exports = class FilterHelper {
     ...
     *
     * @param {import("../types/JsonApiResponse.js").JsonApiRelationshipObject["data"]} relationships
     * @param {Set<string>} allowListSimple
     * @returns
     */
     ...
     *
     * @template R
     * @param {import("../types/PromiseHandler.js").PromiseHandler<R> | import("./promisifyHandler.js")<R>} handler
     ...
     */
    static getHelper(handler, request, resourceConfig) {
        if(handler.handlesFilter || !request.processedFilter) {
            return new DummyFilterHelper()
        } else {
            return new FilterHelper(request.processedFilter, resourceConfig)
        }
    }

    /**
     *
     * @param {Record<string, import("../types/Filter.js").FilterSpec[]>} processedFilter
     * @param {import("../types/ResourceConfig.js").ResourceConfig} resourceConfig
     */
    constructor(processedFilter, resourceConfig) {
        this.#processedFilter = processedFilter
        this.#relationships = new Set(Relationship.getAllRelationships(resourceConfig).map(([r]) => r))
    }

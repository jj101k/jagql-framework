...
/**
 * @typedef {{search?(request: import('../types/Handler.js').JsonApiRequest, b: any, c: any), find?(request: import('../types/Handler.js').JsonApiRequest, b: any), create?(request:
 * import('../types/Handler.js').JsonApiRequest, b: any), update?(request: import('../types/Handler.js').JsonApiRequest, b: any), delete?(request: import('../types/Handler.js').JsonApiRequest)}} Handlers
 */

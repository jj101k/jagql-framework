...
const ourJoi = module.exports = {
   ...
   * @returns
   */
  getActionSettings(resourceConfig, actionName) {
    resourceConfig.actionSettings ??= {}
    if(!(actionName in resourceConfig.actionSettings)) {
      resourceConfig.actionSettings[actionName] = this.getSettings(resourceConfig.actions[actionName])
    }
    return resourceConfig.actionSettings[actionName]
  },

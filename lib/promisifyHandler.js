...
/**
 * @template R
 * @implements {PromiseHandler<R>}
 */
export class PromisifyHandler {
    /**
     * @template R
     * @param {import("../types/ResourceConfig.js").ResourceConfig<R>["handlers"] |
     * null} handler
     */
    static for(handler) {
    ...
    /**
     *
     * @param {import("../types/CallbackHandler.js").CallbackHandler<R>} handler
     */
    constructor(handler) {

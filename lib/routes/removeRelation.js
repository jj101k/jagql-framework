...
removeRelationRoute.register = () => {
  router.bindRoute({
    ...
    try {
      ...
      const theirResource = await Promisify.promisifySingle(resourceConfig.handlers, "find")(request)
      ...
      await Promisify.promisify(resourceConfig.handlers, "update")(request, update)

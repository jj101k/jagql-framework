...
removeRelationRoute.register = () => {
  router.bindRoute({
    ...
    try {
      ...
      let [theirResource] = await Promisify.promisifyFull(resourceConfig.handlers.find.bind(resourceConfig.handlers))(request)
      ...
      let sanitisedData = await responseHelper._checkSchemaOnObject(newResource, resourceConfig.attributes)

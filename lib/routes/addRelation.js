...
addRelationRoute.register = () => {
  router.bindRoute({
    ...
    let sanitisedData
    try {
      await Promisify.promisify(helper.verifyRequest.bind(helper))(request, resourceConfig, res, 'update')
      await Promisify.promisify(helper.verifyRequest.bind(helper))(request, resourceConfig, res, 'find')
      await Promisify.promisify(helper.checkForBody.bind(helper))(request)
      ...
      await Promisify.promisify(helper.validate.bind(helper))(theirResource, resourceConfig.onCreate)

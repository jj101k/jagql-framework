        ...
        router.bindRoute({
            ...
            if("next" in r) {
                ...
                for await (const [sr, pi] of r) {
                    ...
                    sanitisedData.push(...await responseHelper.generateDataItems(page, resourceConfig))
                    paginationInfo += pi
                ...
                sanitisedData = await responseHelper.generateDataItems(searchResults, resourceConfig)
            }
